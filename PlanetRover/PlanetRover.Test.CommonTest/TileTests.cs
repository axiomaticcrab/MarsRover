...
namespace PlanetRover.Test.CommonTest
{
    ...
    public class TileTests
    {
        ...
        public void Should_FindNeighbourTile_When_RequestedDirectionIsSouth()
        {
            ...
            var neighbourTilePosition = tile.FindNeighbourTilePosition(directionManager.GetDirections().First(d => d.Code == "S"));
        ...
        public void Should_FindNeighbourTile_When_RequestedDirectionIsEast()
        {
            ...
            var neighbourTilePosition = tile.FindNeighbourTilePosition(directionManager.GetDirections().First(d => d.Code == "E"));
        ...
        public void Should_FindNeighbourTile_When_RequestedDirectionIsWest()
        {
            ...
            var neighbourTilePosition = tile.FindNeighbourTilePosition(directionManager.GetDirections().First(d => d.Code == "W"));
